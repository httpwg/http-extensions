...
and another to the same third party in another. Or they might even allow or set
some third-party cookies, but block others depending on user-agent cookie policy
or user controls.
