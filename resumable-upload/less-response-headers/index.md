# Editor's drafts for resumable-upload/less-response-headers branch of [httpwg/http-extensions](https://github.com/httpwg/http-extensions/tree/resumable-upload/less-response-headers)
