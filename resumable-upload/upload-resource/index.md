# Editor's drafts for resumable-upload/upload-resource branch of [httpwg/http-extensions](https://github.com/httpwg/http-extensions/tree/resumable-upload/upload-resource)
