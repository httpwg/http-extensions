# Editor's drafts for resumable-upload/inconsistent-length branch of [httpwg/http-extensions](https://github.com/httpwg/http-extensions/tree/resumable-upload/inconsistent-length)
