# Editor's drafts for resumable-upload/references branch of [httpwg/http-extensions](https://github.com/httpwg/http-extensions/tree/resumable-upload/references)
