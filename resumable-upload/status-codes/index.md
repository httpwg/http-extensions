# Editor's drafts for resumable-upload/status-codes branch of [httpwg/http-extensions](https://github.com/httpwg/http-extensions/tree/resumable-upload/status-codes)
