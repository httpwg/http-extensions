# Editor's drafts for shepherd-incr branch of [httpwg/http-extensions](https://github.com/httpwg/http-extensions/tree/shepherd-incr)

| Draft |     |     |     |
| ----- | --- | --- | --- |
| [Requesting Incremental Forwarding of HTTP Messages](./draft-ietf-httpbis-incremental.html "Requesting Incremental Forwarding of HTTP Messages (HTML)") | [plain text](./draft-ietf-httpbis-incremental.txt "Requesting Incremental Forwarding of HTTP Messages (Text)") | same as main |
