...
We thus introduce the concept of representation digest
that is the value of the output of a digest-algorithm defined in {{algorithms}},
...
The digest is computed on the entire
