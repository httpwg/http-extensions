# Editor's drafts for resumable-upload-header-fields branch of [httpwg/http-extensions](https://github.com/httpwg/http-extensions/tree/resumable-upload-header-fields)
