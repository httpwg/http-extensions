...
When using the Capsule Protocol, TCP payload data is sent in the payload of a new Capsule Type named DATA ({{data-capsule}}).  Future specifications may establish the meaning of DATA capsules with other Upgrade Tokens.
