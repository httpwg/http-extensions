# Editor's drafts for resumable-upload-length-upfront-1 branch of [httpwg/http-extensions](https://github.com/httpwg/http-extensions/tree/resumable-upload-length-upfront-1)
