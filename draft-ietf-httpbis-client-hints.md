...
Client Hints may be combined with Variants response header field (<https://tools.ietf.org/html/draft-ietf-httpbis-variants-05>) to enable fine-grained control of the cache key for improved cache efficiency.
