...
names := rfc6265bis key client-hints cookie-prefixes cookie-alone origin-frame cookie-same-site cache-digest header-structure expect-ct early-hints rand-access-live replay
...
friendly_names := rfc6265bis key client-hints cookie-prefixes cookie-alone origin-frame cookie-same-site cache-digest header-structure expect-ct early-hints rand-access-live replay
