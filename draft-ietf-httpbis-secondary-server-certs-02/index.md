# Editor's drafts for draft-ietf-httpbis-secondary-server-certs-02 branch of [httpwg/http-extensions](https://github.com/httpwg/http-extensions/tree/draft-ietf-httpbis-secondary-server-certs-02)
...
| [No-Vary-Search](./draft-ietf-httpbis-no-vary-search.html "The No-Vary-Search HTTP Caching Extension (HTML)") | [plain text](./draft-ietf-httpbis-no-vary-search.txt "The No-Vary-Search HTTP Caching Extension (Text)") | same as main |
| [HTTP Unencoded Digest](./draft-ietf-httpbis-unencoded-digest.html "HTTP Unencoded Digest (HTML)") | [plain text](./draft-ietf-httpbis-unencoded-digest.txt "HTTP Unencoded Digest (Text)") | same as main |
