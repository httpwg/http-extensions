...
This specification uses Structured Headers {{!I-D.ietf-httpbis-header-structure}} to specify syntax. The terms sh-list, sh-item, sh-string, sh-token, sh-integer and key refer to the structured types defined therein.
...
* Name: \[a name for the Proxy Error Type that matches sh-token\]
